...
export const frFR: TranslationSchema = {
	ext: {
		...
		skills: {
			title: 'Compétences',
			description:
				'Automatisations réutilisables et paramétrées que l’agent peut exécuter sur les pages correspondantes.',
			teachHint:
				'Enregistrez une nouvelle compétence à la voix avec le bouton Apprendre du panneau latéral.',
			empty:
				'Aucune compétence pour l’instant. Affinez-en une depuis du texte ci-dessous ou utilisez le bouton Apprendre du panneau latéral.',
			...
			skillDescriptionPlaceholder: 'Ce qu’elle fait et quand l’utiliser',
			plan: 'Étapes',
			planPlaceholder: 'Étapes ordonnées suivies par l’agent ; utilisez {param} pour les entrées',
			...
			refineFromText: 'Affiner depuis du texte',
			refineHint: 'Collez ou saisissez une narration ; l’IA la structure en compétence.',
			transcriptPlaceholder: 'Décrivez les étapes en langage clair…',
			refine: 'Affiner',
			refining: 'Affinage…',
			reRefine: 'Réaffiner',
			refined: 'Compétence affinée.',
			refineFailed: 'Échec de l’affinage',
			refineNeedsLlm: 'Configurez d’abord un fournisseur d’IA.',
			needNarration: 'Saisissez d’abord une narration.',
			noTranscript: 'Aucune narration enregistrée à affiner.',
		},
		teach: {
			open: 'Apprendre une compétence',
			title: 'Apprendre une compétence',
			hint: 'Décrivez les étapes en regardant la page.',
			record: 'Enregistrer',
			stop: 'Arrêter',
			transcribing: 'Transcription…',
			transcript: 'Transcription',
			transcriptPlaceholder: 'Votre narration apparaît ici — modifiez-la si besoin.',
			noVoiceHint:
				'La voix n’est pas configurée. Saisissez les étapes ci-dessous ou activez la voix dans les paramètres.',
			refine: 'Affiner',
			refining: 'Affinage…',
			review: 'Vérifiez et modifiez la compétence, puis enregistrez.',
			save: 'Enregistrer la compétence',
			discard: 'Abandonner',
			close: 'Fermer',
			saved: 'Compétence enregistrée — gérez-la dans Paramètres › Compétences.',
			needTranscript: 'Ajoutez d’abord une narration.',
			refineFailed: 'Échec de l’affinage',
		},
		masking: {
		...
		voice: {
			...
			model: 'Modèle',
			voice: 'Voix',
			voicePlaceholder: 'Voix par défaut',
			noVoices: 'Aucune voix trouvée',
			apiKey: 'Clé API',
			...
			pushToTalkHelp: 'Maintenez une touche pour enregistrer ; relâchez pour envoyer.',
			holdKey: 'Touche à maintenir',
			holdKeyHelp:
				'Touche à maintenir pendant que vous parlez (ex. Alt). Fonctionne sur la page et dans le panneau.',
			language: 'Langue',
